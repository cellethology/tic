        ...
        **kwargs
        ...
        Dict[str, Any]
            A dictionary containing:
                ...
                - detailed_stats: Detailed statistics for each lag, including model coefficients.
                - best_model_parameters: The regression model parameters corresponding to the best lag.
        ...
        for lag in sorted(results.keys()):
            ...
            if adj_p_val < best_adj_pvalue:
                ...
                best_lag = lag
                best_model_parameters = coefficients

        if best_lag is None and raw_pvalues:
            best_lag = min(raw_pvalues.keys())
            best_model_parameters = stats_info[best_lag]["coefficients"]
