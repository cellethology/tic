...
if __name__ == "__main__":
    # Create a CellInfo object
    cell = CellInfo(region_id="UPMC_c001_v001_r001_reg001", cell_id=1, raw_dir="/Users/zhangjiahao/Project/tic/data/example/voronoi")
    print(cell)
    print(cell.to_dict())
    cell.save("cell_info.pkl")
    loaded_cell = CellInfo.load("cell_info.pkl")
    print(loaded_cell)
    print(loaded_cell.to_dict())
    print(loaded_cell.biomarker_expression)